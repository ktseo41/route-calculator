...
const SharePreview = forwardRef<HTMLDivElement, SharePreviewProps>(
  ({ rLL, customText }, ref) => {
    ...
    return (
      <div ref={ref} className="share-preview-container">
        {/* Table Header */}
        ...
        <div className="share-preview-footer">
          {/* URL */}
          <div className="share-preview-footer__url">{queryToSave}</div>

          {/* Signature */}
          <div className="share-preview-footer__signature">
            <img src={logo} alt="Logo" className="share-preview-footer__logo" />
