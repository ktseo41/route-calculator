              ...
              <div className="mb-3">
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <button
                      key={jobName}
                      className="text-sm px-3 py-2 bg-[#4a4a4a] hover:bg-[#5a5a5a] text-[#ffffff] hover:text-white rounded border border-[#6a6a6a] transition-all duration-200 hover:border-[#00aaff] shadow-[inset_1px_1px_1px_rgba(255,255,255,0.1),_inset_-1px_-1px_1px_rgba(0,0,0,0.5)]"
                      onClick={addNewJob}
                    >
                      {jobName}
                    </button>
