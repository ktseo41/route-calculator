...
const rawRouteData: RawRouteData[] = [
  {
    jobName: "악사",
    cumulativePoint: 100,
    expectedStats: { STR: 5, INT: 30, AGI: 10, VIT: 5 },
  },
  {
    jobName: "궁사",
    cumulativePoint: 100,
    expectedStats: { STR: 10, INT: 10, AGI: 30, VIT: 5 },
  },
  {
    jobName: "자객",
    cumulativePoint: 100,
    expectedStats: { STR: 20, INT: 10, AGI: 30, VIT: 5 },
  },
  {
    jobName: "검객",
    cumulativePoint: 100,
  ...
  },
  {
    jobName: "투사",
    cumulativePoint: 100,
    expectedStats: { STR: 30, INT: 10, AGI: 20, VIT: 10 },
  },
  {
    jobName: "무도가",
    cumulativePoint: 100,
    expectedStats: { STR: 20, INT: 10, AGI: 20, VIT: 30 },
  },
  {
    jobName: "전사",
    cumulativePoint: 100,
    expectedStats: { STR: 30, INT: 10, AGI: 10, VIT: 30 },
  },
  {
    jobName: "검사",
    cumulativePoint: 100,
  ...
  },
  {
    jobName: "상인",
    cumulativePoint: 100,
    expectedStats: { STR: 10, INT: 10, AGI: 30, VIT: 30 },
  },
  {
    jobName: "모험가",
    cumulativePoint: 20,
  ...
  },
  {
    jobName: "자연인",
    cumulativePoint: 100,
    expectedStats: { STR: 21, INT: 10, AGI: 40, VIT: 40 },
  },
  {
    jobName: "어둠의기사",
    cumulativePoint: 100,
    expectedStats: { STR: 41, INT: 20, AGI: 24, VIT: 60 },
  },
  {
    jobName: "어둠의마법사",
    cumulativePoint: 100,
    expectedStats: { STR: 41, INT: 40, AGI: 44, VIT: 44 },
  },
  {
    jobName: "빛의마법사",
    cumulativePoint: 100,
    expectedStats: { STR: 41, INT: 60, AGI: 60, VIT: 28 },
  },
  {
    jobName: "탐색가",
    cumulativePoint: 70,
    expectedStats: { STR: 41, INT: 52, AGI: 70, VIT: 21 },
  },
  {
    jobName: "순수마법사",
    cumulativePoint: 57,
    expectedStats: { STR: 30, INT: 70, AGI: 70, VIT: 20 },
  },
  {
    jobName: "모험가",
    cumulativePoint: 100,
    expectedStats: { STR: 30, INT: 70, AGI: 70, VIT: 30 },
  }, // 모험가: 100 - 20 = 80
  {
    jobName: "빛의기사",
    cumulativePoint: 100,
    expectedStats: { STR: 50, INT: 70, AGI: 54, VIT: 50 },
  },
  {
    jobName: "순수기사",
    cumulativePoint: 50,
    expectedStats: { STR: 66, INT: 60, AGI: 54, VIT: 66 },
  },
  {
    jobName: "순수마법사",
    cumulativePoint: 87,
    expectedStats: { STR: 60, INT: 70, AGI: 60, VIT: 60 },
  }, // 순수마법사: 87 - 57 = 30
  {
    jobName: "탐색가",
    cumulativePoint: 100,
    expectedStats: { STR: 60, INT: 66, AGI: 70, VIT: 56 },
  }, // 탐색가: 100 - 70 = 30
  {
    jobName: "순수마법사",
    cumulativePoint: 100,
    expectedStats: { STR: 57, INT: 70, AGI: 70, VIT: 53 },
  }, // 순수마법사: 100 - 87 = 13
  {
    jobName: "순수기사",
    cumulativePoint: 100,
    expectedStats: { STR: 70, INT: 60, AGI: 70, VIT: 70 },
  }, // 순수기사: 100 - 50 = 50
];
